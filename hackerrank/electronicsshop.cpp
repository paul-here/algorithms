/*
* HackerRank link: https://www.hackerrank.com/challenges/electronics-shop/problem
* Title: electronicsshop.cpp
* Abstract: The getMoneySpent() function takes two integer vectors representing 
*           keyboard and  drive prices, and an integer representing the max 
*           budget, and returns the most expensive combination that possible.
*           If no combination is possible, it returns -1. Code outside of the 
*           getMoneySpent() function was provided by hackerrank.
* Author: Paul Whipp
* Date: 05/18/2020
*/
